      ...
      <div className="px-3 sm:px-6 py-3 sm:py-4">
        ...
        {isMenuOpen && (
          <div className="mt-4 xl:hidden border-t border-white/10 pt-4">
            <nav className="flex flex-col space-y-4" style={{fontFamily: "var(--font-SUSE)"}}>
              {['Store', 'Library', 'Community', 'Esports', 'News'].map((item) => (
                <button key={item} className="text-gray-300 hover:text-white transition-colors font-medium text-left py-2">
                  {item}
                </button>
              ))}
